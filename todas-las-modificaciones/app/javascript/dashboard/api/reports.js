...
class ReportsAPI extends ApiClient {
  ...
  getFirstContactHeatmaps({ from, to, direction, inboxIds, groupBy = 'hour' } = {}) {
    return axios.get(`${this.url}/first_contact_heatmaps`, {
      params: { 
        since: from, 
        until: to, 
        direction, 
  ...
  getFirstContactsSummary({ from, to, inboxIds } = {}) {
    return axios.get(`${this.url}/first_contacts_summary`, {
      params: { 
        since: from, 
        until: to, 
        inbox_ids: inboxIds,
