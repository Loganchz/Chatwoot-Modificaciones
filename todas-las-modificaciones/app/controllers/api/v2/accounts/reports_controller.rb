class Api::V2::Accounts::ReportsController < Api::V1::Accounts::BaseController
  ...
  include Api::V2::Accounts::FirstContactHeatmapHelper
  ...
  def first_contact_heatmaps
    ...
    @report_data = V2::Reports::FirstContactHeatmapBuilder.new(Current.account, builder_params).build
  ...
  def first_contacts_summary
    ...
    conversations = Current.account.conversations.where(created_at: since_date..until_date)
    contacts = Current.account.contacts.where(created_at: since_date..until_date)
    ...
    if params[:inbox_ids].present? && params[:inbox_ids] != 'undefined' && params[:inbox_ids].to_s != '0'
      ...
      contacts = contacts.joins(:contact_inboxes).where(contact_inboxes: { inbox_id: inbox_ids }).distinct
    end
